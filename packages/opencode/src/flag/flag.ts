...
export namespace Flag {
  ...
  /** When set, emit one JSON line per LLM request on stderr with system-prompt digest (merged text markers). */
  export const OPENCODE_DEBUG_SYSTEM = truthy("OPENCODE_DEBUG_SYSTEM")
